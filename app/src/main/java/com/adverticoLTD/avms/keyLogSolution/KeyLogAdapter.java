package com.adverticoLTD.avms.keyLogSolution;
...
public class KeyLogAdapter extends BaseAdapter implements Filterable {
    ...
    public KeyLogAdapter(Context context, List<String> arrayList,
                         HashMap<String, Boolean> selectedHashMap) {
        ...
        holder.textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selectedHashMap.containsKey(arrayList.get(position))) {
                    selectedHashMap.put(arrayList.get(position), false);
                } else {
